...
def get_args_parser():
    ...
    parser.add_argument('--accum_iter', type=int, help='Accumulate gradient iterations')
    ...
    parser.add_argument('--drop_path', type=float, metavar='PCT', help='Drop path rate')
    parser.add_argument('--clip_grad', type=float, metavar='NORM', help='Clip gradient norm')
    parser.add_argument('--weight_decay', type=float, help='weight decay')
    parser.add_argument('--lr', type=float, metavar='LR', help='learning rate')
    parser.add_argument('--blr', type=float, metavar='LR', help='base learning rate')
    ...
    parser.add_argument('--color_jitter', type=float, metavar='PCT', help='Color jitter factor')
    parser.add_argument('--aa', type=str, default='rand-m9-mstd0.5-inc1', metavar='NAME', help='Use AutoAugment policy'),
    parser.add_argument('--smoothing', type=float, help='Label smoothing')
    parser.add_argument('--reprob', type=float, metavar='PCT', help='Random erase prob')
    parser.add_argument('--remode', type=str, help='Random erase mode')
    parser.add_argument('--recount', type=int, help='Random erase count')
    parser.add_argument('--resplit', action='store_true', help='Do not random erase first (clean) augmentation split')
    parser.add_argument('--mixup', type=float, help='mixup alpha, mixup enabled if > 0.')
    parser.add_argument('--cutmix', type=float, help='cutmix alpha, cutmix enabled if > 0.')
    parser.add_argument('--cutmix_minmax', type=float, nargs='+', help='cutmix min/max ratio, overrides alpha and enables cutmix if set')
    parser.add_argument('--mixup_prob', type=float, help='Probability of performing mixup or cutmix when either/both is enabled')
    parser.add_argument('--mixup_switch_prob', type=float, help='Probability of switching to cutmix when both mixup and cutmix enabled')
    parser.add_argument('--mixup_mode', type=str, help='How to apply mixup/cutmix params. Per "batch", "pair", or "elem"')
